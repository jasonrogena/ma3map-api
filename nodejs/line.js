...
Line.prototype.getPoints = function() {
   ...
   db.runQuery("select shape_pt_lat as point_lat, shape_pt_lon as point_lon, shape_pt_sequence as  point_sequence, shape_dist_traveled as dist_traveled from \"gtfs_shapes\" WHERE shape_id = '"+data.line_id+"' order by shape_pt_sequence", context, function(context, dbData){
